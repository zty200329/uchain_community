...
//
//    @Value("${myPro.savePath}")
//    private String savePath;
//
//    @Value("${myPro.saveUrl}")
//    private String saveUrl;
//
//    @Value("${myPro.rootPath}")
...
//
//        // 文件保存目录URL
////        String saveUrl = "http://localhost:8080/showImg?imgUrl=";
//
//        // 定义允许上传的文件扩展名
//        log.info("--------------------------");
...
public class MainController {
    ...
    public String fileUpload(String callBackPath, MultipartHttpServletRequest request, HttpServletResponse response) throws IOException {
